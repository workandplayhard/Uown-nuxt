<template>
  <div class="container relative mt-from-header" style="height: 1000px">
    <!-- <emailPopup /> -->
    <!-- <cld-image
      public-id="Screen_Shot_2019-10-31_at_11.02.20_rzsxll.png"
      width="200"
      height="200"
      crop="fill"
    ...
    <!-- <cld-image
      public-id="uown/Foto-3_c8znnq.jpg"
      secure="true"
      dpr="auto"
      responsive="width"
      width="auto"
    ...
    <p>{{formatURL}}</p> -->
    <!-- <button class="p-4 border" @click="getToken">send message</button> -->
    <phone-form :list="countries" class="mt-4" />
  </div>
</template>

<script>
// const emailPopup = () => import("@/components/LearnAboutRiskPopup");

export default {
  components: {
    // emailPopup,
    PhoneForm: () => import("@/components/PhoneForm"),
  },
  ...
  data() {
    return {
      ...
      countries: [
        ...
        { name: "land Islands", dialCode: "+358", code: "AX" },
  ...
  computed: {
    formatURL() {
      let str =
        "https://res.cloudinary.com/uown/image/upload/c_scale,dpr_1.0,w_600/c_fill,dpr_auto,f_auto,w_auto/v1/uown/Foto-3_c8znnq.jpg";
      str = str.split("/");
